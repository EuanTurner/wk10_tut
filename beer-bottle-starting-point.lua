...
JD = Bezier:new{points={J, JD_b1, D}}
DJ = Bezier:new{points={D, JD_b1, J}}
...
BJ = Line:new{p0=B, p1=J}
AI = Line:new{p0=A, p1=I}
...
patch = {}
patch[0] = CoonsPatch:new{north=IJ, east=BJ, south=AB, west=AI}
patch[1] = CoonsPatch:new{north=JD, east=CD, south=BC, west=BJ}
patch[2] = CoonsPatch:new{north=JK, east=EK, south=DE, west=DJ}
...
grid = {}
grid[0] = StructuredGrid:new{psurface=patch[0], niv=n4+1, njv=n2+1}
grid[1] = StructuredGrid:new{psurface=patch[1], niv=n4+1, njv=n2+1}
grid[2] = StructuredGrid:new{psurface=patch[2], niv=n4+1, njv=n2+1}
